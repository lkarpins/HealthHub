...
describe("Activity", () => {
  ...
  it("should be able to determine if a user reached their step goal for a given day", () => {
    ...
    const determinedStepGoalReachedPerDay2 = user2Activity.returnStatusOfDailyStepGoal("2019/06/17", user2);
  ...
  it("should be able to find the days where a user exceeded their step goal", () => {
    const determinedStepGoalExceededPerDay1 = user1Activity.returnDaysStepGoalExceeded(user1);
    const determinedStepGoalExceededPerDay2 = user2Activity.returnDaysStepGoalExceeded(user2);
  ...
  it("should be able to find average steps taken for all user's on a given day", () => {
    const avgStepsTakenPerDay1 = user1Activity.returnAvgActivityDataAllUsers("2019/06/16");
    const avgStepsTakenPerDay2 = user2Activity.returnAvgActivityDataAllUsers("2019/06/17");
